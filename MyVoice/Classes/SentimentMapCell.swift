...
class SentimentMapCell: BaseAnalyticsCell {
    ...
    override func addExtraViewOnTabBar(view: UIView) {
        firstButton = DLRadioButton(frame: CGRect(x: view.frame.width - 270, y: 10, width: 240, height: 30))
        firstButton.setTitle(MyStrings.neighbourhood, forState: UIControlState.Normal)
        ...
        secondButton.setTitle(MyStrings.state, forState: UIControlState.Normal)
